...
# 0510 bag
    ...
    # #########3end_time=1694932920.00
    fileLio="/home/xiefujing/research/area_graph/ws/robotPoseResult/DATASET/seq02GT.txt"
    fileRobot="/home/xiefujing/research/area_graph/ws/robotPoseResult/DATASET/seq02_Amcl_AreaGraph.txt"
    ...
    np.savetxt("/home/xiefujing/research/area_graph/ws/robotPoseResult/DATASET/seq02GTTranscated.txt",LioResultTranscated,fmt='%lf',delimiter=' ')
    np.savetxt("/home/xiefujing/research/area_graph/ws/robotPoseResult/DATASET/seq02_Amcl_AreaGraph_Transcated.txt",RobotResultTranscated,fmt='%lf',delimiter=' ')